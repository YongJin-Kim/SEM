...
{
	partial class FilamentRunningTime
	{
		/// <summary>
		/// 필수 디자이너 변수입니다.
		/// </summary>
		...
		private void InitializeComponent()
		{
			...
			this.button1.Tag = "FRT_Reset";
			this.button1.Text = "FRT_Reset";
			...
			this.label1.Text = "9999days 99:99:99";
			...
			this.groupBox1.Tag = "FRT_Filament";
			this.groupBox1.Text = "FRT_Filament";
			// 
			// FilamentRunningTime
			// 
