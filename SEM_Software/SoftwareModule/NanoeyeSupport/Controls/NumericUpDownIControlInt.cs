...
{
	public partial class NumericUpDownIControlInt : NumericUpDown
	{
		...
		public NumericUpDownIControlInt()
		{
			InitializeComponent();
		}
			...
			if (_ControlValue != null)
			{
				if (_UsePrecision)
				{
					...
					case DisplayTypeEnum.DefaultMinimum:
						break;
					case DisplayTypeEnum.Maximum:
						_ControlValue.Maximum = (int)((double)this.Value * _ControlValue.Precision);
						break;
					case DisplayTypeEnum.Minimum:
						_ControlValue.Minimum = (int)((double)this.Value * _ControlValue.Precision);
						break;
					case DisplayTypeEnum.Offset:
						_ControlValue.Offset = (int)((double)this.Value * _ControlValue.Precision);
						break;
					case DisplayTypeEnum.Value:
						_ControlValue.Value = (int)((double)this.Value * _ControlValue.Precision);
						break;
					}
				}
				else
				{
					...
					case DisplayTypeEnum.DefaultMinimum:
						break;
					case DisplayTypeEnum.Maximum:
						_ControlValue.Maximum = (int)((double)this.Value );
						break;
					case DisplayTypeEnum.Minimum:
						_ControlValue.Minimum = (int)((double)this.Value );
						break;
					case DisplayTypeEnum.Offset:
						_ControlValue.Offset = (int)((double)this.Value );
						break;
					case DisplayTypeEnum.Value:
						_ControlValue.Value = (int)((double)this.Value );
						break;
					}
				}
			}
