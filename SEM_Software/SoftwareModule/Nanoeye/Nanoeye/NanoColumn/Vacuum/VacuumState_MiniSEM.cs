...
{
	internal class VacuumState_MiniSEM : ColumnInt
	{
		protected override void SendValue(int value)
		{
			switch (value)
			{
			case 0:
		...
		protected override object[] ReadInnder()
		{
			...
			else
			{
				...
				case 0x02:
				case 0x03:
					returns[0] = "System Pumping";
					break;
				case 0x40:
					returns[0] = "Observation Ready";
					break;
				case 0x80:
				case 0x81:
				case 0x82:
				case 0x83:
					returns[0] = "System Venting";
					break;
				case 0xC0:
					returns[0] = "Air";
					break;
