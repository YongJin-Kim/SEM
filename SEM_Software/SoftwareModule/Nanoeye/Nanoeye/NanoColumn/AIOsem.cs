...
namespace SEC.Nanoeye.NanoColumn
{
    class AIOsem : SEMbase, I4000M
    {
        ...
        protected virtual void GunAlignInit()
        {
            ...
            rotateX.DefaultMin = 0d;
            rotateX.Maximum = 1d;
            rotateX.Minimum = 0d;
            rotateX.Value = 0.5d;
            rotateX.Precision = 1d / 4095d;
            rotateX.EndInit();
            ...
            rotateY.DefaultMin = 0d;
            rotateY.Maximum = 1d;
            rotateY.Minimum = 0d;
            rotateY.Value = 0.5d;
            rotateY.Precision = 1d / 4095d;
            rotateY.EndInit();
        ...
        protected virtual void BeamShiftInit()
        {
            ...
            xRotate.DefaultMin = 0;
            xRotate.Maximum = 1;
            xRotate.Minimum = 0;
            xRotate.Value = 2047;
            xRotate.Precision = 1 / 4095d;
            xRotate.EndInit();
            ...
            yRotate.DefaultMin = 0;
            yRotate.Maximum = 1;
            yRotate.Minimum = 0;
            yRotate.Value = 2047;
            yRotate.Precision = 1 / 4095d;
            yRotate.EndInit();
        ...
        protected virtual void ScanInit()
        {
            ...
            //icvd.Value = 2047d;
            //icvd.Precision = 1d / 4095d;
            //icvd.setter = MiniSEM_Devices.Scan_AmpX;
            //icvd.readLower = MiniSEM_Devices.Noting;
            //icvd.readUpper = MiniSEM_Devices.Noting;
            //icvd.readlowerConst = 1.0d;
            //icvd.readupperConst = 1.0d;
            //icvd.EndInit();
            //controls.Add("ScanAmpX", icvd);
            #endregion
            ...
            //icvd.Value = 2047d;
            //icvd.Precision = 1d / 4095d;
            //icvd.setter = MiniSEM_Devices.Scan_AmpY;
            //icvd.readLower = MiniSEM_Devices.Noting;
            //icvd.readUpper = MiniSEM_Devices.Noting;
            //icvd.readlowerConst = 1.0d;
            //icvd.readupperConst = 1.0d;
            //icvd.EndInit();
            //controls.Add("ScanAmpY", icvd);
            #endregion
            ...
            icvd.Value = 2048d;
            icvd.Precision = 1d / 4095d;
            icvd.setter = MiniSEM_Devices.Scan_AlignX;
            icvd.readLower = MiniSEM_Devices.Noting;
            icvd.readUpper = MiniSEM_Devices.Noting;
            icvd.readlowerConst = 1.0d;
            icvd.readupperConst = 1.0d;
            icvd.EndInit();
            controls.Add("ScanGeoXA", icvd);
            #endregion
            ...
            icvd.Value = 2048d;
            icvd.Precision = 1d / 4095d;
            icvd.setter = MiniSEM_Devices.Scan_AlignY;
            icvd.readLower = MiniSEM_Devices.Noting;
            icvd.readUpper = MiniSEM_Devices.Noting;
            icvd.readlowerConst = 1.0d;
            icvd.readupperConst = 1.0d;
            icvd.EndInit();
            controls.Add("ScanGeoXB", icvd);
            #endregion
            ...
            icvd.Value = 2048d;
            icvd.Precision = 1d / 4095d;
            icvd.setter = MiniSEM_Devices.Scan_AmpXA;
            icvd.readLower = MiniSEM_Devices.Noting;
            icvd.readUpper = MiniSEM_Devices.Noting;
            icvd.readlowerConst = 1.0d;
            icvd.readupperConst = 1.0d;
            icvd.EndInit();
            controls.Add("Scan_AmpXA", icvd);
            #endregion
            ...
            icvd.Value = 2048d;
            icvd.Precision = 1d / 4095d;
            icvd.setter = MiniSEM_Devices.Scan_AmpXB;
            icvd.readLower = MiniSEM_Devices.Noting;
            icvd.readUpper = MiniSEM_Devices.Noting;
            icvd.readlowerConst = 1.0d;
            icvd.readupperConst = 1.0d;
            icvd.EndInit();
            controls.Add("Scan_AmpXB", icvd);
            #endregion
            ...
            icvd.Value = 2048d;
            icvd.Precision = 1d / 4095d;
            icvd.setter = MiniSEM_Devices.Scan_AmpYA;
            icvd.readLower = MiniSEM_Devices.Noting;
            icvd.readUpper = MiniSEM_Devices.Noting;
            icvd.readlowerConst = 1.0d;
            icvd.readupperConst = 1.0d;
            icvd.EndInit();
            controls.Add("Scan_AmpYA", icvd);
            #endregion
            ...
            icvd.Value = 2048d;
            icvd.Precision = 1d / 4095d;
            icvd.setter = MiniSEM_Devices.Scan_AmpYB;
            icvd.readLower = MiniSEM_Devices.Noting;
            icvd.readUpper = MiniSEM_Devices.Noting;
            icvd.readlowerConst = 1.0d;
            icvd.readupperConst = 1.0d;
            icvd.EndInit();
            controls.Add("Scan_AmpYB", icvd);
            #endregion
