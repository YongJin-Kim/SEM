...
namespace SEC.Nanoeye.NanoColumn
{
	public interface IMiniSEM : ISEMController
	{
		...
		SECtype.ITable ScanMagTable { get; }


        SECtype.IControlDouble BSEAmpC { get; }
        SECtype.IControlDouble BSEAmpD { get; }
