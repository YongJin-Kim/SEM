...
namespace SEC.Nanoeye.NanoColumn
{
	...
	/// 통신의 형태
	/// </summary>
	internal enum MiniSEM_DeviceType : ushort
	{
		EepromWrite = 0,
		EepromRead = 1,
		Get = 1,
	...
	internal enum MiniSEM_DeviceParser : ushort
	{
		Board = 0xf000,
		Inst = 0x0ff0,
		Type = 0x000f,
	...
	/// 통신 대상
	/// </summary>
	internal enum MiniSEM_Devices : ushort
	{
		Noting = 0,
		...
		#region Scan
		Scan_AlignX = 0X4010,           //new Controller -> ScanGeoXA
        Scan_AlignY = 0X4020,           //new Controller -> ScanGeoXB
        Scan_AmplitudeX = 0X4030,       //new Controller -> ScanGeoYA
        Scan_AmplitudeY = 0X4040,       //new Controller -> ScanGeoYB
		Scan_ExtSelect = 0X4050,
		Scan_MagnificationX = 0X4060,
		Scan_MagnificationY = 0X4070,
		Scan_Rotation = 0X4080,
		Scan_FeedbackMode = 0X4090,
		//Scan_DynamicFocus = 0x40A0,
		...
		Vacuum_StageLock = 0x6080,
		Vacuum_AirSpring = 0x6090,
		Vacuum_Door = 0x60A0,
		Vacuum_Valve = 0x60B0,
		Vacuum_ProcessTime = 0x60C0,
		Vacuum_EDS = 0x60D0,
		Vacuum_Date = 0x6F00,
		Vacuum_Time = 0x6F10,
		Vacuum_LastError = 0x6F20,
		Vacuum_ResetCode = 0x6F30,
        Vacuum_Camera = 0x60E0,
	...
	/// </summary>
	internal enum MiniSEM_DevicesFullName : ushort
	{
		#region Align
		...
		#region Scan
        Scan_AlignX_Get = 0X4011,           //new Controller -> Scan_GeoXA_Get
        Scan_AlignX_Set = 0X4012,           //new Controller -> Scan_GeoXA_Set
        Scan_AlignY_Get = 0X4021,           //new Controller -> Scan_GeoXB_Get
        Scan_AlignY_Set = 0X4022,           //new Controller -> Scan_GeoXB_Set
        Scan_AmplitudeX_Get = 0X4031,       //new Controller -> Scan_GeoYA_Get
        Scan_AmplitudeX_Set = 0X4032,       //new Controller -> Scan_GeoYA_Set
        Scan_AmplitudeY_Get = 0X4041,       //new Controller -> Scan_GeoYB_Get
        Scan_AmplitudeY_Set = 0X4042,       //new Controller -> Scan_GeoYB_Set

        //new Controller 추가
        Scan_AmpXA_Get = 0X40A1,
        Scan_AmpXA_Set = 0X40A2,
        Scan_AmpXB_Get = 0X40B1,
        Scan_AmpXB_Set = 0X40B2,
        Scan_AmpYA_Get = 0X40C1,
        Scan_AmpYA_Set = 0X40C2,
        Scan_AmpYB_Get = 0X40D1,
        Scan_AmpYB_Set = 0X40D2,
		...
		Vacuum_Relay1FromC1_Get = 0x6061,
		Vacuum_Relay1FromC1_Set = 0x6062,
		Vacuum_LowVacuum_Get = 0x6071,
		Vacuum_LowVacuum_Set = 0x6072,
		Vacuum_StageLock_Get = 0x6081,
		Vacuum_StageLock_Set = 0x6082,
		Vacuum_AirSpring_Get = 0x6091,
		Vacuum_AirSpring_Set = 0x6092,
		Vacuum_Door_Get = 0x60A1,
		Vacuum_Door_Set = 0x60A2,
		Vacuum_Valve_Read = 0x60B3,
		Vacuum_ProcessTime_Read = 0x60C3,
		Vacuum_LastError_Get = 0x6F21,
		Vacuum_ResetCode_Get = 0x6F31,
        Vacuum_Camera_Get = 0x60E1,
        Vacuum_Camera_Set = 0x60E2,

		#endregion

        #region BSE
        BSE_Detector_Set = 0x7012,
        BSE_Filter_Set = 0x7022,
        ...
        #region Variable Aperture
        VariableX_Get = 0x1091,
        VariableX_Set = 0x1092,

        VariableY_Get = 0x10A1,
        VariableY_Set = 0x10A2,
