...
{
	internal class NIDaq6361 : NIDaq6351
	{
		public NIDaq6361(string device)
		{
			daqDevice = device;
		...
		public static string[] SearchNIDaq6361()
{
			...
			foreach (string deviceName in DaqSystem.Local.Devices)
			{
				...
				if (device.ProductType.Contains("6361"))
				{
