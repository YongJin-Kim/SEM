...
{
    public partial class ImageForcusBar : Control
    {
        #region Property & Variables
        //private Rectangle leftRect;
        //private Rectangle rightRect;
		private Rectangle panelRect;
        private Rectangle pushpanelRect;
        ...
        public Image PanelIcon
        {
            ...
            {
                _panelIcon = value;
                this.Invalidate(panelRect);
            }
        }

        private Image _pushpanelIcon = null;
        public Image PushPanelIcon
        {
            get { return _pushpanelIcon; }
            set
            {
                _pushpanelIcon = value;
                this.Invalidate(pushpanelRect);
            }

        }

        private bool panelPush = false;
		...
		/// 표시할 문자열을 사용자가 지정 한다.
		/// </summary>
        public Func<ImageForcusBar, string> UserValueString;
		...
		protected override void OnPaint(PaintEventArgs e)
		{
			...
			//Helper.GuiPainter.DrawButtonEllipse(g, panelRect, _ButtonLeftStyle.BackColor, _ButtonLeftStyle.ColorStart, _ButtonLeftStyle.ColorCenter, leftBswm);
            //Helper.GuiPainter.DrawButtonEllipse(g, panelRect, _ButtonRightStyle.BackColor, _ButtonRightStyle.ColorStart, _ButtonRightStyle.ColorCenter, rightBswm);
            ...
            if (panelPush)
            {
                ...
                g.DrawImage(_pushpanelIcon, this.ClientRectangle);
            }
            else
            {
                g.DrawImage(_panelIcon, this.ClientRectangle);
			...
			if (_IndicatorVisiable)
			{
                ...
                //{
                    valueRect = new Rectangle(panelRect.X + (panelWidthHalf / 2), panelRect.Y, panelWidthHalf, panelRect.Height);
                //}
                //else
                //{
                ...
                //valueRect = new Rectangle(panelRect.X * 2 , panelRect.Y, panelWidthHalf, panelRect.Height);
			}
			else
			{
				valueRect = panelRect;
            ...
            g.DrawString(str, this.Font, new SolidBrush(Color.FromArgb(188,188,188)), valueRect, sf);
		...
		private void CalControlBounce()
		{
			if (_ButtonSizeAuto)
			{
				...
				panelRect = new Rectangle(this.ClientRectangle.Left, this.ClientRectangle.Top, 134, 40);
			}
			else
			{

                panelRect = new Rectangle(this.ClientRectangle.Left, this.ClientRectangle.Top, PanelIcon.Width, PanelIcon.Height);
			}
